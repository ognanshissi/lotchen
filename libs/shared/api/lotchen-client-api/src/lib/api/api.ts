...
export const APIS = [AgenciesApiService, AuthApiService, OrganizationsApiService, PermissionsApiService, ProfileApiService, RolesApiService, TeamsApiService, TerritoriesApiService, UsersApiService];
