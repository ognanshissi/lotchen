...
export const APIS = [AgenciesApiService, AuthApiService, CallerApiService, ContactsApiService, OrganizationsApiService, PermissionsApiService, ProfileApiService, RolesApiService, TeamsApiService, TerritoriesApiService, UsersApiService];
